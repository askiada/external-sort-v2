...
// PushBack provides a mock function with given fields: row, size
func (_m *MockVector) PushBack(row interface{}, size int64) error {
	ret := _m.Called(row, size)
...
// PushFrontNoKey provides a mock function with given fields: row, size
func (_m *MockVector) PushFrontNoKey(row interface{}, size int64) error {
	ret := _m.Called(row, size)
