...
func (_m *MockAllocateVectorFnfunc) Execute(_a0 func(interface{}) (model.Key, error)) vector.Vector {
	ret := _m.Called(_a0)
	...
	if rf, ok := ret.Get(0).(func(func(interface{}) (model.Key, error)) vector.Vector); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
